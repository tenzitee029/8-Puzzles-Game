...
class PygameApp:
    ...
    def run_search_thread(self):
        ...
        from core.csp_problem import Puzzle8CSP
        csp_problem = Puzzle8CSP(self.goal_state)
        ...
        elif selected_algo == "AND-OR_Graph": self.path = and_or_graph_search(self.initial_state, self.goal_state, self.append_log)
        elif selected_algo == "Belief_FullyObs": self.path = belief_fully_observable_search(self.initial_state, self.goal_state, self.append_log)
        elif selected_algo == "Belief_Unobserved": self.path = belief_unobservable_search(self.initial_state, self.goal_state, self.append_log)
        elif selected_algo == "Belief_PartialObs": self.path = belief_partially_observable_search(self.initial_state, self.goal_state, self.append_log)
        elif selected_algo == "CSP_Backtracking": self.path = backtracking_search(csp_problem, self.append_log)
    ...
    def main_loop(self):
        ...
        while running:
            ...
            self.clock.tick(config.FPS)
        pygame.quit()
>>>>>>> 72738f666174b033596d190f1bd45171d50458fe
